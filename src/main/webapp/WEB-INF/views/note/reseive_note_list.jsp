...
<table border="1" width="60%">
	<tr>
		<th>쪽지 번호</th><th>보낸 사람</th><th>제목</th><th>확인여부</th>
	</tr>
	<c:forEach items="${reseive_note_list }" var="reseive">
	<tr onclick="detail('${reseive.note_no}')">
		<td>${reseive.note_no }</td><td>${reseive.from_id }</td><td>${reseive.note_title }</td><td>${reseive.note_chk }</td>
	</tr>
	</c:forEach>
</table>
</body>
